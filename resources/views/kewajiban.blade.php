...
<div class="bg-gray-50 min-h-screen flex flex-col" x-data="{ 
    rows: JSON.parse(localStorage.getItem('kewajibanRows') || '[]'),
    newRow: {
        code: '',
        name: '',
        amount: '',
    ...
    init() {
        if (this.rows.length === 0) {
            this.rows = [
                { code: '51', name: 'Beban Gaji', amount: '2', isEditing: false },
                { code: '52', name: 'Beban Bensin', amount: '2', isEditing: false },
                { code: '53', name: 'Beban Makan dan Minum', amount: '2', isEditing: false },
                { code: '54', name: 'Beban Perawatan', amount: '2', isEditing: false }
            ];
            this.saveData();
        }
    },
    saveData() {
        localStorage.setItem('kewajibanRows', JSON.stringify(this.rows));
        localStorage.setItem('totalKewajiban', this.getTotal());
    },
    getTotal() {
        ...
        <div id="main-content" class="relative text-black ml-72 font-poppins w-full h-full overflow-y-auto">
            ...
            <div class="bg-white p-6 mx-6 mt-6 rounded-xl shadow-sm">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-black">Kewajiban</h1>
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-sm">
                            ...
                            <tr class="bg-gray-50 text-black">
                                <td colspan="2" class="py-2 px-4 border font-medium text-center">JUMLAH KEWWAJIBAN</td>
                                <td class="py-2 px-4 border"></td>
