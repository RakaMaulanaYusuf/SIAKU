            ...
            <div class="bg-white p-6 mx-6 mt-6 rounded-xl shadow-sm">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Daftar kode bantu perusahaan</p>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr class="bg-blue-600 text-white text-sm">
                                ...
                                <th class="py-3 px-4 text-right w-36">SALDO AWAL</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200 text-sm">
                            ...
                            <template x-for="(account, index) in accounts.filter(a => 
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="py-2 px-4 border-r" x-text="account.helper_id"></td>
                                    <td class="py-2 px-4 border-r" x-text="account.name"></td>
                                    <td class="py-2 px-4 border-r" x-text="account.status"></td>
                                    <td class="py-2 px-4 text-right">
                                        <span x-text="account.balance ? 'Rp. ' + new Intl.NumberFormat('id-ID').format(account.balance) : '-'"></span>
                                    </td>
                                </tr>
                            </template>
                        </tbody>
                ...
                <div class="flex justify-between mt-6">
                    <button onclick="window.location.href='{{ route('vkodebantu.download-pdf') }}'"
