        ...
        <div class="relative h-full bg-white shadow-lg rounded-r-3xl">
            ...
            <nav class="mt-2" :class="isOpen ? 'px-3' : 'px-2'">
                <template x-for="(item, index) in [
                    {name: 'Dashboard', route: '/vdashboard', icon: 'M4 6h16M4 12h16M4 18h16'},
                    {name: 'List Period', route: '/listPeriods', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'},
                    {name: 'Kode Akun', route: '/vkodeakun', icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z'},
                    {name: 'Kode Bantu', route: '/vkodebantu', icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z'},
                    {name: 'Jurnal Umum', route: '/vjurnalumum', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'},
                    {name: 'Buku Besar', route: '/vbukubesar', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'},
                    {name: 'Buku Besar Pembantu', route: '/vbukubesarpembantu', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'},
                    {name: 'Laba Rugi', route: '/vlabarugi', icon: 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z'},
                    {name: 'Neraca', route: '/vneraca', icon: 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z'}
                ]">
                    <a :href="item.route" 
                ...
                <div class="flex items-center p-4" :class="isOpen ? 'justify-between' : 'justify-center'">
                    <div class="flex items-center min-w-0">
                        <div class="relative flex-shrink-0">
                            <img src="{{ asset('images/ponidi.jpg') }}" alt="Profile" 
                                 class="w-10 h-10 rounded-full border-2 border-blue-200 transform transition-transform group-hover:scale-105">
