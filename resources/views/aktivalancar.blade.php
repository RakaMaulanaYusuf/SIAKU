...
@section('title', 'Aktiva Lancar')

@section('page')
<div class="bg-gray-50 min-h-screen flex flex-col" x-data="{ 
    rows: JSON.parse(localStorage.getItem('aktivalancarRows') || '[]'),
    newRow: {
        code: '',
        name: '',
        amount: '',
    ...
    init() {
        if (this.rows.length === 0) {
            this.rows = [
                { code: '51', name: 'Beban Gaji', amount: '1', isEditing: false },
                { code: '52', name: 'Beban Bensin', amount: '1', isEditing: false },
                { code: '53', name: 'Beban Makan dan Minum', amount: '1', isEditing: false },
                { code: '54', name: 'Beban Perawatan', amount: '1', isEditing: false }
            ];
            this.saveData();
        }
    },
    saveData() {
        localStorage.setItem('aktivalancarRows', JSON.stringify(this.rows));
        localStorage.setItem('totalAktivalancar', this.getTotal());
    },
    getTotal() {
        ...
        <div id="main-content" class="relative text-black ml-72 font-poppins w-full h-full overflow-y-auto">
            ...
            <div class="bg-white p-6 mx-6 mt-6 rounded-xl shadow-sm">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-black">Aktiva Lancar</h1>
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-sm">
                            ...
                            <tr class="bg-gray-50 text-black">
                                <td colspan="2" class="py-2 px-4 border font-medium text-center">JUMLAH AKTIVA LANCAR</td>
                                <td class="py-2 px-4 border"></td>
