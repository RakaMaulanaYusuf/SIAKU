...
<div class="bg-gray-50 min-h-screen flex flex-col" x-data="{ 
    rows: JSON.parse(localStorage.getItem('ekuitasRows') || '[]'),
    newRow: {
        code: '',
        name: '',
        amount: '',
    ...
    saveData() {
        localStorage.setItem('ekuitasRows', JSON.stringify(this.rows));
        localStorage.setItem('totalEkuitas', this.getTotal());
    },
    getTotal() {
        return this.rows.reduce((sum, row) => sum + (Number(row.amount) || 0), 0);
    },
    getTotalKewajibandanEkuitas() {
        const totalKewajiban = Number(localStorage.getItem('totalKewajiban')) || 0;
        const totalEkuitas = this.getTotal();
        ...
        <div id="main-content" class="relative text-black ml-72 font-poppins w-full h-full overflow-y-auto">
            ...
            <div class="bg-white p-6 mx-6 mt-6 rounded-xl shadow-sm">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-black">Ekuitas</h1>
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-sm">
                            ...
                            <tr class="bg-gray-50 text-black">
                                <td colspan="2" class="py-2 px-4 border font-medium text-center">JUMLAH EKUITAS</td>
                                <td class="py-2 px-4 border"></td>
                                <td class="py-2 px-4 border text-right font-medium" x-text="formatNumber(getTotal())"></td>
                                <td class="py-2 px-4 border"></td>
                            </tr>
                            <tr class="bg-gray-50 text-black">
                                <td colspan="2" class="py-2 px-4 border font-medium text-center">TOTAL KEWAJIBAN DAN EKUITAS</td>
                                <td class="py-2 px-4 border"></td>
                                <td class="py-2 px-4 border text-right font-medium" x-text="formatNumber(getTotalKewajibandanEkuitas())"></td>
                                <td class="py-2 px-4 border"></td>
                            </tr>
                        </tbody>
                    </table>
