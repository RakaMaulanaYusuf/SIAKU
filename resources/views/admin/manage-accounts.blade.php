            ...
            <div class="bg-white p-6 mx-6 mt-6 rounded-xl shadow-sm">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Manajemen akun staff dan viewer</p>
                    </div>
                            ...
                            <tr class="hover:bg-gray-50" data-user-id="{{ $user->id }}">
                                        ...
                                        <div class="flex-shrink-0 h-10 w-10">
                                            ...
                                            @else
                                                <div class="h-10 w-10 rounded-full bg-gradient-to-br 
                                                    ...
                                                    @if($user->role === 'viewer') from-yellow-400 to-yellow-500 @endif
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        <button class="text-yellow-600 hover:text-yellow-900 reset-password-btn" 
