...
<body>
    ...
    <div class="account-info">
        <table class="account-table">
            <tr>
                <td class="account-name">NAMA AKUN: {{ $account->name }}</td>
                <td class="account-code">KODE AKUN: {{ $account->account_id }}</td>
            </tr>
        </table>
    </div>
            ...
            <tr>
                ...
                <td class="text-right">
                    @if($account->balance_type == 'DEBIT')
                        {{ number_format($account->debit ?? 0, 0, ',', '.') }}
                    @else
                        {{ number_format($account->credit ?? 0, 0, ',', '.') }}
                    @endif
                </td>
            </tr>
