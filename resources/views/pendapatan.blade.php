...
<div class="bg-gray-50 min-h-screen flex flex-col" x-data="{ 
    rows: JSON.parse(localStorage.getItem('pendapatanRows') || '[]'),
    newRow: {
        code: '',
        name: '',
        amount: '',
    ...
    saveData() {
        localStorage.setItem('pendapatanRows', JSON.stringify(this.rows));
        localStorage.setItem('totalPendapatan', this.getTotal());
    },
    getTotal() {
        ...
        <div id="main-content" class="relative text-black ml-72 font-poppins w-full h-full overflow-y-auto">
            ...
            <div class="bg-white p-6 mx-6 mt-6 rounded-xl shadow-sm">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-black">Pendapatan</h1>
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-sm">
                                        ...
                                        <template x-if="row.isEditing">
                                            <div class="flex justify-center gap-2">
                                                ...
                                                <button @click="cancelEdit(row)" 
                                                    class="px-3 py-1.5 border border-red-600 text-red-600 rounded hover:bg-red-50">
                                                    Batal
                                                </button>
                                            </div>
                                        </template>
                            ...
                            <tr class="bg-gray-50 text-black">
                                <td colspan="2" class="py-2 px-4 border font-medium text-center">JUMLAH PENDAPATAN</td>
                                <td class="py-2 px-4 border"></td>
